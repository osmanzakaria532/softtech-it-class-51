        ...
        <div id="hb-files-large-result" class="dup-tree-section hb-files-style">
            <div class="container">
                ...
                <div class="tree-nav-bar" >
                    <div class="container">
                    <button type="button" id="hb-files-large-tree-full-load" class="tree-full-load-button show" >
...
jQuery(document).ready(function($)
{
        ...
        $('.tree-full-load-button')
                ...
                .click(function () {   
                    ...
                    if (cObj.hasClass('show')) {
                        cObj.removeClass('show').addClass('hide').text('<?php echo esc_js(__('show warning only', 'duplicator-pro')) ?>');
    ...
    DupPro.Pack.initArchiveFilesData = function(data)
    {
        ...
        $('#data-arc-status-migratepackage').html(
            DupPro.Pack.setScanStatus(
                data.ARC.Status.PackageIsNotImportable ?
                '<?php echo esc_js('Warn') ?>' : '<?php echo esc_js('Good') ?>'
            )
        );
